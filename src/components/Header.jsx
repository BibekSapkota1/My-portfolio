    ...
    return (
        <div className='shadow-md  w-full fixed bg-gray-900 z-10 '>
            <div className='lg:flex items-center justify-between bg-white lg:bg-transparent py-4 md:px-10 px-7'>
                {/* logo section */}
                <div className='font-bold text-2xl cursor-pointer flex text-black lg:text-white  items-center gap-1'>{/* font-bold is a tailwind class for making the text bold */}
                    Bibek
                </div>
                {/* Menu icon */}
